  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Description Text */}
        <p className="text-xs sm:text-sm lg:text-sm mt-2 lg:mt-0" style={{ fontSize: '14px', fontFamily: 'Cerebri Sans, EuclidCircularB, sans-serif', color: '#000000', whiteSpace: 'normal' }}>
